...
export default function Card(props) {
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-lg flex flex-col sm:basis-1 hover:shadow-2xl bg-gray-300">
      <h2 className="text-center font-semibold">{props.mealName}</h2>
      <img className="w-full" src={props.image} alt={props.mealName} />
      <div className="px-6 py-4 flex-grow bg-grey-900">
